...
class SeminarViewer extends Component
{
    public $seminarId;
    public $seminar;
    ...
    public function loadSeminar()
    {
        $this->seminar = Seminar::with([
    ...
    {
        $totalImages = $this->seminar->galleryItems->count();
        $hasCover = $this->seminar->cover_image ? true : false;
    ...
    {
        return view("livewire.seminar-viewer", [
